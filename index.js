...
images[0].src = "./images/RedRocket.png";
images[1].src = "./images/BlueRocket.png";
images[2].src = "./images/GreenRocket.png";
images[3].src = "./images/YellowRocket.png";
images[4].src = "./images/BlackRocket.png";

var promises = [];

for (let i = 0; i < 5; i++) {
	promises[i] = loadImage(i);
}
...
function Player(){
    ...
    this.drawRec = function drawRecs() {
		...
		context.drawImage(whichImage, this.x, this.y, 20, 40);
		context.beginPath();
        context.closePath();
        this.moveRecs();
    }
